...
import Theme from 'next-styled-css/theme'
...
class Home extends React.Component {
  static getInitialProps = async ({ store }) => {
    // await fetchPostsIfNeeded()(store.dispatch, store.getState, true)
  }
    ...
    return (
      <div className={s.page}>
        <Theme
          variables={{
            colorPrimary,
            colorPrimaryHover: shade(colorPrimary, -8),
            colorPrimaryActive: shade(colorPrimary, -12),
            colorPrimaryShadow: `rgba(${hexToRgb(colorPrimary)}, .5)`,
          }}
        >
          <Style sheet={sheet} />
          <Meta title="Nome" />
          <Toolbar onThemeChange={state => this.setState(state)} />
            ...
            <div className="row py-2">
              {posts.length > 0 && (
                <div className="card w-100">
                  {posts.map(post => (
                    <div key={post.id} className="card-item media p-1">
                      <span
                        className="mr-2"
                        style={{
                          width: '20px',
                      ...
                      <div className="media-body">
                        {post.title}
                        <a href={post.url} className="d-block ts-small">
                          {post.url}
                        </a>
                      </div>
                    </div>
              ...
              <div className="col-md-5">
                <div className="card">
                  <div className="p-3 card-item">
                    <p className="mb-0">
                      Mother’s Day can be a loaded holiday for those of us without moms. On this day
                      every year, I am extra aware of not having had a mom for a really long time.
                    </p>
                  </div>
                  <div
                  ...
                  <div className="p-3">
                    ...
                    <button className="btn btn-primary btn--strong btn--size-small">
                      Like this
                    </button>
                    <button className="btn btn-default btn--strong btn--size-small ml-2">
                      Cancel
                    </button>
                  </div>
                        ...
                        <div className="media-body">
                          <div>
                            ...
                            <p className="mb-0 ts-small">
                              Fuse introduces UX Markup, a declarative-reactive XML-based language
                              for creating native, responsive and smoothly animated interactive
                              components for iOS and Android. UX is easy to learn, fun to write and
                              incredibly powerful.
                            </p>
                          </div>
                          ...
                          <div className="media mt-3">
                            ...
                            <div className="media-body">
                              <div className="d-flex">
                                ...
                                />
                                <button className="btn btn-primary btn--size-small ml-2">
                                  Comment
                                </button>
                              </div>
                ...
                <div className="media mb-4">
                  ...
                  <div className="media-body">
                    ...
                    <div className={`${s.bubble} p-3`}>
                      <p className="mb-0">
                        We would like to share a set of modules, and as we add more than 1 this will
                        not be a good experience for the devs. We know that we can separate out
                        "core" and build it, and then att it into package.json - but this is even
                        worse experience, since devs want to load the solution and work on various
                        modules and bring up the solution. Makes sense? I really think there may be
                        a way to get this to work in next.config.js but we failed getting config
                        right. We tried several days of trials.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="p-5">
            ...
            <div className="row jc-center">
              <div className="col-md-6">
                <div className="card">
                  <div className="pos-relative card-item">
                  ...
                  <div className="p-3 card-item">
                    <p className="mb-2">
                      Inscreva-se para uma avaliação gratuita para começar a usar <br /> o Google
                      Compute Engine
                    </p>
                  ...
                  <div className="ta-center px-3 py-5 bg-accent tc-white card-overflow">
                    ...
                    <button className="btn btn-white tc-accent btn--size-small">
                      Take this note
                    </button>
                  </div>
                  <div className="p-3">
...
export default connect(({ posts }) => ({ posts: posts.nodes }))(Home)
